...
enum class TextColorPref(
    ...
    WIDGET_HEADER(
        "headerTheme", Shading.LIGHT, R.string.appearance_header_theme_title,
        "widgetHeaderTextColor", -0x65000001, R.string.widget_header_text_color,
        R.attr.header, BackgroundColorPref.WIDGET_HEADER, false, TimeSection.ALL
    ),
    DAY_HEADER_PAST(
        "dayHeaderThemePast", Shading.LIGHT, R.string.day_header_theme_title,
        "dayHeaderTextColorPast", -0x333334, R.string.day_header_text_color,
        R.attr.dayHeaderTitle, BackgroundColorPref.PAST_EVENTS, true, TimeSection.PAST
    ),
    EVENT_PAST(
        "entryThemePast", Shading.WHITE, R.string.appearance_entries_theme_title,
        "eventTextColorPast", -0x1, R.string.event_text_color,
        R.attr.eventEntryTitle, BackgroundColorPref.PAST_EVENTS, false, TimeSection.PAST
    ),
    DAY_HEADER_TODAY(
        "dayHeaderTheme", Shading.DARK, R.string.day_header_theme_title,
        "dayHeaderTextColorToday", -0x888889, R.string.day_header_text_color,
        R.attr.dayHeaderTitle, BackgroundColorPref.TODAYS_EVENTS, true, TimeSection.TODAY
    ),
    EVENT_TODAY(
        "entryTheme", Shading.BLACK, R.string.appearance_entries_theme_title,
        "eventTextColorToday", -0x1000000, R.string.event_text_color,
        R.attr.eventEntryTitle, BackgroundColorPref.TODAYS_EVENTS, false, TimeSection.TODAY
    ),
    DAY_HEADER_FUTURE(
        "dayHeaderThemeFuture", Shading.LIGHT, R.string.day_header_theme_title,
        "dayHeaderTextColorFuture", -0x333334, R.string.day_header_text_color,
        R.attr.dayHeaderTitle, BackgroundColorPref.FUTURE_EVENTS, true, TimeSection.FUTURE
    ),
    EVENT_FUTURE(
        "entryThemeFuture", Shading.WHITE, R.string.appearance_entries_theme_title,
        "eventTextColorFuture", -0x1, R.string.event_text_color,
