...
class IllegalInstantDueToTimeZoneTransitionTest : BaseWidgetTest() {
    ...
    private fun reproducedTimeZoneOffsetTransitionException() {
        ...
        var localDateTime = LocalDateTime(dateTimeZone)
            .withYear(2011)
            .withMonthOfYear(3)
            .withDayOfMonth(27)
            .withHourOfDay(2)
        ...
        try {
            ...
            Log.v(
                TAG, "Sure enough, invalid instant due to time zone offset transition: "
                    + localDateTime
            )
        }
    ...
    fun testPeriodicAlarmTimeDuringTimeGap() {
        try {
            ...
            val nowWinnipeg = DateTime(
                2020, 3, 8,
                1,
                54, zone
            ).plusSeconds(37)
            val expWinnipeg = DateTime(
                2020, 3, 8,
                1 + 2,
